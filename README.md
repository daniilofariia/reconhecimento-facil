...
Este repositório foi criado com a finalidade de atualizar o sistema de reconhecimento facial

O trabalho desenvolvido faz parte  do projeto  de *"Extenção para analise e desenvolvimento de sistemas da Anhanguera"*
...
Trabalho desenvolvido por **Danilo Barros** 
